...
const About = () => {
  return (
    <section className="container grid grid-cols-1 md:grid-cols-6 lg:grid-cols-5 md:grid-row-7 gap-4 mx-auto w-full" id="about-me">
        <Card title="About me" headingShowAs='h3' className='row-span-1 flex flex-col lg:col-span-3 md:col-span-6 md:row-span-4 text-center'>
          <div itemType="https://schema.org/Person" itemScope>
            <Image itemProp="image" src="/assets/me.png" alt="Gracjan Drozdek" width={280} height={280} className='mx-auto'/>
            <p>
        ...
        <Card title="Education & Experience" headingLevel='h3' headingShowAs='h5' className='row-span-1 lg:col-span-2 md:col-span-3 md:row-span-2  flex flex-col'>
          {experience && experience.map((item, index) => (
            <div key={index} className={`${index+1 !== experience.length && 'border-b border-white-100'} py-2`}>
